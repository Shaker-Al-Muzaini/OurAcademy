                                                ...
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <input class="primary_input_field addTitle"
                                                               ...
                                                               placeholder="-"
                                                               type="text"
                                                               value="{{old('title',$blog->getTranslation('title',$language->code))}}"
                                                               required>
                                                    </div>
                                                </div>
                                                <div class="col-xl-12">
                                                    <div class="primary_input mb-35">
                                                        ...
                                                        <textarea class="lms_summernote"
                                                                  ...
                                                                  cols="30"
                                                                  rows="10">{{old('description',$blog->getTranslation('description',$language->code))}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                                        ...
                                                        <div class="col-md-6 mb-25">
                                                            <label class="primary_checkbox d-flex mr-12"
                                                                ...
                                                                <input type="radio"
                                                                       ...
                                                                       id="type1"
                                                                       name="audience"
                                                                       value="1" {{$blog->audience==1?'checked':''}}>
                                                                <span
                                                        ...
                                                        <div class="col-md-6  mb-25">
                                                            <label class="primary_checkbox d-flex mr-12"
                                                                ...
                                                                <input type="radio"
                                                                       ...
                                                                       id="type2" {{$blog->audience==2?'checked':''}}
                                                                       name="audience"
