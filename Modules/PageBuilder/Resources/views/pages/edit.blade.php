                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="primary_input mb-15">
                                ...
                                <input class="primary_input_field" id="title" name="title" placeholder="{{__('page-builder.Title')}}" type="text" value="{{$row->title}}">
                        ...
                        <div class="col-lg-12">
                            <div class="primary_input mb-15">
                                ...
                                <input class="primary_input_field" id="slug" name="slug" placeholder="{{__('page-builder.Slug')}}" type="text" value="{{$row->slug}}">
