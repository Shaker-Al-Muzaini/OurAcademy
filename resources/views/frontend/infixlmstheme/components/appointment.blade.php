@if (in_array('hero-section', $hasDescription))
    ...
    <?php echo $decription; ?>
@else
    @include('appointment::snippet.components._hero_area')
@endif
...
@if (in_array('feature-01', $hasDescription))
    ...
    <?php echo $decription; ?>
@else
    @include('appointment::snippet.components._feature_01')
@endif
...
@if (in_array('feature-02', $hasDescription))
    ...
    <?php echo $decription; ?>
@else
    @include('appointment::snippet.components._feature_02')
@endif
...
@if (in_array('feature-03', $hasDescription))
    ...
    <?php echo $decription; ?>
@else
    @include('appointment::snippet.components._feature_03')
@endif
...
@if (in_array('feature-04', $hasDescription))
    ...
    <?php echo $decription; ?>
@else
    @include('appointment::snippet.components._feature_04')
@endif
...
@if (in_array('feature-05', $hasDescription))
    ...
    <?php echo $decription; ?>
@else
    @include('appointment::snippet.components._feature_05')
@endif
...
@if (in_array('feature-06', $hasDescription))
    ...
    <?php echo $decription; ?>
@else
    @include('appointment::snippet.components._feature_06')
@endif
...
@if (in_array('feature-07', $hasDescription))
    ...
    <?php echo $decription; ?>
@else
    @include('appointment::snippet.components._feature_07')
@endif
